...
class KMeans:
    ...
    def fit(self, X):
        ...
        barrier_workers = [worker_results[2] for worker_results in workers_results]
        self.barrier_duration = sum(barrier_workers) / len(barrier_workers)
...
class Worker:
    ...
    def run(self):
        ...
        return (self.labels, self.times, self.barrier_duration)