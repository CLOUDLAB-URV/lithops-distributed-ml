...
class KMeans:
    ...
    def initialize_workers(self):
        ...
        for worker_idx in range(self.n_workers):
            worker = Worker(worker_idx, self.n_clusters, self.max_iter, self.centroids_initialized, self.cluster_centers, self.clusters_totals, self.clusters_counters, self.barrier, self.has_converged, self.labels, locks_clusters)
...
class Worker:
    def __init__(self, worker_id, n_clusters, max_iter, centroids_initialized, cluster_centers, clusters_totals, clusters_counters, barrier, has_converged, labels, locks_clusters):
